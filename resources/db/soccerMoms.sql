...
-- Volcando estructura para tabla soccermoms.archivo_detalles

-- Volcando datos para la tabla soccermoms.archivo_detalles: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `archivo_detalles` DISABLE KEYS */;
/*!40000 ALTER TABLE `archivo_detalles` ENABLE KEYS */;
